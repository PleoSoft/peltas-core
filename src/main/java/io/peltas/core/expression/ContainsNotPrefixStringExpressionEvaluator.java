...
public class ContainsNotPrefixStringExpressionEvaluator extends AbstractEvalatorExpression {
	public ContainsNotPrefixStringExpressionEvaluator() {
		super("containsNotPrefixString");
	}
